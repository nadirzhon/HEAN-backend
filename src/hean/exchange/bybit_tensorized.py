...
from ..core.python.causal_brain import MarketState, CausalBrain
...
class BybitTensorizedMonitor:
    ...
    def __init__(self, api_key: Optional[str] = None, 
                 ...
                 causal_brain: Optional[CausalBrain] = None):
        ...
        self.current_proxy: Optional[ProxyNode] = None
        ...
        self.orderflow_tensor: Optional[OrderflowTensor] = None
        ...
        self.proxy_check_task: Optional[asyncio.Task] = None
    ...
    def _select_fastest_proxy(self) -> Optional[ProxyNode]:
    ...
    def get_tensor(self) -> Optional[OrderflowTensor]:
