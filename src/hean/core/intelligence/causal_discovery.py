...
class CausalDiscoveryEngine:
    ...
    def _calculate_granger_causality(self, asset_a: str, asset_b: str, max_lag: int = 50) -> tuple[float, int] | None:
        """
    ...
    def _calculate_transfer_entropy(self, asset_a: str, asset_b: str) -> float | None:
        """
