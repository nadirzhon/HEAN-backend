...
class TCNPredictor(nn.Module):
    ...
    def __init__(self, input_size: int = 4, num_channels: list = [64, 64, 64, 64], kernel_size: int = 3, dropout: float = 0.2):
...
class TCPriceReversalPredictor:
    ...
    def predict_reversal_probability(self) -> Tuple[float, bool]:
        """
