...
class DistributedNodeManager:
    ...
    def __init__(
        ...
        node_addresses: Optional[Dict[NodeRegion, str]] = None,
        ...
        # Current master node
        self._master_node: Optional[NodeRegion] = None
        ...
        # Callbacks
        self._trade_execution_callback: Optional[Callable] = None
    ...
    async def _disconnect_from_nodes(self) -> None:
        ...
        for region, client in list(self._grpc_clients.items()):
            try:
