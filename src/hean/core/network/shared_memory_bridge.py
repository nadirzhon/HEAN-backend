...
from ctypes import Structure, c_char, c_double, c_int64, c_uint32, c_uint8, c_uint64
...
class SharedMemoryBridge:
    ...
    def __init__(self, shm_name: str = "hean_feed_ring", mutex_name: str = "hean_feed_mutex"):
        ...
        self._mutex: Optional[posix_ipc.Semaphore] = None
        self._read_index = 0
    ...
    def _read_tick_at_index(self, index: int) -> Optional[TickData]:
