...
class DynamicAPIScouter:
    ...
    def __init__(
        ...
        self._current_fastest: Optional[NodeLatency] = None
        self._last_switch_time = time.time()
        
        # Callback for notifying Executor of endpoint change
        self._endpoint_change_callback: Optional[callable] = None
    ...
    def get_fastest_endpoints(self) -> Tuple[Optional[str], Optional[str]]:
