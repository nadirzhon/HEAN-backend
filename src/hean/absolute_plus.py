...
class AbsolutePlusSystem:
    ...
    def __init__(self, 
        ...
        # Core components
        self.causal_brain: Optional[CausalBrain] = None
        self.market_monitor: Optional[BybitTensorizedMonitor] = None
        self.evolution_terminal: Optional[EvolutionTerminal] = None
    ...
    async def _main_loop(self):
        ...
        if self.enable_ui and self.evolution_terminal:
            ui_task = asyncio.create_task(self.evolution_terminal.run())
